...
%{python2_sitelib}/collectd_gnocchi-%{version}-py?.?.egg-info
...
%changelog
* Thu Oct 05 2017 Matthias Runge <mrunge@redhat.com> - 1.6.0-1
- update to 1.6.0

* Tue Oct 03 2017 Matthias Runge <mrunge@redhat.com> - 1.4.1-1
- update to 1.4.1

* Fri Mar 31 2017 Matthias Runge <mrunge@redhat.com> - 1.4.0-1
- Initial package.
